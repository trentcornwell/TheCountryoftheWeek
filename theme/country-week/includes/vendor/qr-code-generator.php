...
--$col;
    ...
    function createBytes(&$buffer, &$rsBlocks) {
        ...
        $dcdata = self::createNullArray(count($rsBlocks) );
        ...
        for ($r = 0; $r < $rsBlockCount; $r++) {
            ...
            $dcdata[ $r ] = self::createNullArray($dcCount);
            ...
            $ecdata[ $r ] = self::createNullArray($rsPoly->getLength() - 1);
        ...
        $data = self::createNullArray($totalCodeCount);
